      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h1 className="text-[42px] leading-[50px] md:text-[72px] font-bold md:leading-[85px]">
            {t("hero.greeting")}{" "}
            <span className="bg-[#FF6B7A] text-white px-3 py-1 inline-block">{t("hero.name")}</span>,{" "}
            <span className="bg-[#2F81F7] text-white px-3 py-1 inline-block">{t("hero.title")}</span>
          </h1>
