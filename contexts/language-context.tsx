...
const translations = {
  fr: {
    ...
    about: {
      ...
      education1Title: "Master en Informatique",
      education1School: "Université de Technologie",
      education1Desc: "Spécialisation en développement web et mobile, architecture logicielle et gestion de projets.",
      education2Title: "Licence en Informatique",
      education2School: "Université des Sciences",
      education2Desc:
        "Formation générale en informatique couvrant les bases de données, les réseaux et la programmation.",
      education3Title: "Baccalauréat Scientifique",
      education3School: "Lycée Général",
      education3Desc: "Spécialité Mathématiques et Sciences de l'Ingénieur, mention Bien.",
