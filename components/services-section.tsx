        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-4xl md:text-[52px] md:leading-[60px] font-bold mb-4">
              {t("services.title")}{" "}
              <span className="bg-[#FF4A60] text-white px-3 py-1 inline-block">{t("services.titleHighlight")}</span>
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#FFC224] border-[3px] border-black rounded-[32px] p-8 md:p-12 flex flex-col items-center justify-center text-center hover:translate-y-[-4px] transition-transform min-h-[480px] relative shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
              ...
              <h3 className="text-[28px] leading-[40px] font-bold mb-4 text-[#0B0B0B]">{t("services.ctaTitle")}</h3>
              <p className="text-[18px] leading-[30px] font-medium text-[#393939] mb-8">{t("services.ctaDesc")}</p>
