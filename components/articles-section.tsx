      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-[0.9fr_1.1fr] gap-6 mb-16">
          ...
          <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
            <div className="bg-[#EDEDED] relative min-h-55 md:min-h-80 m-3 md:m-4 rounded-2xl overflow-hidden">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center gap-3 md:gap-4">
                ...
                <div>
                  <div className="font-bold text-base md:text-lg text-[#0B0B0B]">KPOSSILANDE Géovic</div>
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="group bg-white border-[3px] border-black rounded-3xl overflow-hidden hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all duration-300">
              <div className="flex flex-col sm:flex-row">
                {/* Image area */}
                <div className="bg-[#EDEDED] min-w-full sm:min-w-50 md:min-w-70 min-h-45 sm:min-h-50 relative m-0 sm:m-3 md:m-4 rounded-none sm:rounded-2xl overflow-hidden shrink-0">
